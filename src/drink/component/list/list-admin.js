    ...
    return {
        ...
        execute: function() {
            ListComponent = (function () {
                function ListComponent(_drinkService) {
                    this._drinkService = _drinkService;
                }
                ListComponent.prototype.getDrinkList = function () {
                    var _this = this;
                    this.drinkList = [];
                    this._drinkService.getList().then(function (Drinks) { return _this.drinkList = Drinks; });
                ...
                ListComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [drink_1.DrinkService])
                ], ListComponent);
